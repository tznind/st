(function() {
  ...
  function initializeGhostConsequences(container) {
    // Wire up X buttons
    ...
    function updateVisibility() {
      ...
      container.querySelectorAll('[data-gc-mark]').forEach(function(item) {
  ...
  window.CardInitializers['ghost-consequences'] = initializeGhostConsequences;
})();
